...
export const sendOtpEmail = async (targetEmail, otpCode) => {
  const mailOptions = {
    from: `"Smart Adapler Assistant" <${process.env.MAIL_USER}>`,
    to: targetEmail,
    subject: "Your Account Verification OTP Code",
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        <h2 style="color: #333; text-align: center;">Smart Adapler Assistant Account Verification</h2>
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        ...
        <p>Hello, we received a request to change the email address of your Smart Adapler Assistant account. Use the OTP code below to verify your new email:</p>
        <div style="text-align: center; margin: 30px 0;">
          <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #4CAF50; background: #f4f4f4; padding: 10px 20px; border-radius: 5px; display: inline-block;">
            ${otpCode}
          </span>
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        ...
        <p>Hello, we received a request to reset the password for your Smart Adapler Assistant account. Use the OTP code below to continue:</p>
        <div style="text-align: center; margin: 30px 0;">
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 5px;">
        ...
        <p>We received a request to delete your Smart Adapler Assistant account. Use the OTP code below to continue the account deletion process:</p>
        <div style="text-align: center; margin: 30px 0;">
